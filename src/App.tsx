  ...
  <div className="flex justify-between items-end">
    <span>28.Reference</span><span>34</span>
        ...
        <Page pageNumber={10}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 4.Scope of the project </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">The scope of this micro-project encompasses the conceptualization, design, fabrication, and testing of a small-scale prototype of the Smart Waste Segregation System. The system limits its sorting capability to three primary categories: organic/wet, metallic, and general dry waste. It utilizes a specific set of sensors—including capacitive, moisture, and inductive sensors—interfaced with an Arduino Uno microcontroller.</p><p className="indent-12 mb-6">While the current prototype is designed for indoor and controlled environments such as educational campuses or small offices, the underlying architecture is modular. The project scope does not cover large-scale industrial deployment, municipal-level integration, or advanced AI-based visual sorting, but establishes a foundational framework upon which such features can be built in the future.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={14}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 8.IPR Strategy </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">To protect the core innovations of this project, a multi-faceted Intellectual Property Rights (IPR) strategy is considered. The unique configuration of the sensor array and the algorithm governing the sequential sensor polling and motor actuation are potentially eligible for a <strong>Utility Patent</strong>, provided they meet novelty requirements.</p><p className="indent-12 mb-6">Additionally, the specific physical design of the rotating sorting platform and the ergonomic exterior housing could be protected under an <strong>Industrial Design Registration</strong>. All circuit schematics, source code, and calibration parameters will initially be maintained as <strong>Trade Secrets</strong> to maintain competitive advantage during the early commercialization phases.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={16}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 10.System Operation Workflow </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
        ...
        <Page pageNumber={18}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 12.Design Methodology </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">We adopted an iterative, systems-engineering approach. The process began with requirement gathering and constraint mapping (e.g., power limits, dimensions, budget). We then decomposed the system into three main subsystems: Sensor and Input, Processing and Control, and Mechanical Actuation.</p><p className="indent-12 mb-6">For the Mechanical Actuation subsystem, we utilized CAD software to model the intake chamber and diverter flap, ensuring optimal angles for gravity-assisted sliding. In the Processing subsystem, we developed the Arduino C++ firmware, heavily utilizing state-machine logic to prevent blocking delays. Each subsystem was prototyped and tested individually using breadboards before final integration and PCB fabrication.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={20}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 14.System Description </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">The fully assembled Smart Waste Segregation System consists of an upper detection chamber, a central motorized sorting module, and a lower dual-compartment storage area. The upper chamber houses the IR, moisture, and inductive sensors, arranged linearly to maximize surface contact with the falling waste.</p><p className="indent-12 mb-6">The central controller, an Arduino Uno, is securely mounted in an isolated side panel to protect it from moisture and physical impact. LED status indicators (Red for Metal, Green for Wet, Blue for Dry) are mounted on the exterior chassis to provide immediate visual feedback to the user regarding the classification outcome.</p>
          <div className="mt-12 scale-[0.8] origin-top flex justify-center w-full"><BlockDiagram /></div>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={22}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 16.Fabrication </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">The fabrication process involved both subtractive and additive manufacturing techniques. The main structural chassis was constructed from 3mm acrylic sheets, which were precisely cut to size using a laser cutter to ensure tight tolerances. Edges were sanded to remove burrs.</p><p className="indent-12 mb-6">The internal diverter flap was custom 3D printed using PLA filament with an infill of 30% to maintain a high strength-to-weight ratio. Sensor mounting brackets were fabricated from bendable aluminum strips, allowing easy adjustment of sensor positioning and angles during the calibration phase.</p>
            </div>
          </div>
        </Page>
        {/* PAGE 23: 17.Assembly */}
        ...
        <Page pageNumber={24}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 18.Testing & Results </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">Testing was divided into component-level unit testing and full system integration testing. Unit testing verified the calibration thresholds: the inductive sensor correctly identified aluminum and steel cans at a distance of 4mm, and the moisture sensor successfully differentiated between wet paper and dry plastic based on analog voltage thresholds.</p><p className="indent-12 mb-6">During integration testing, a sample set of 100 mixed objects (30 metallic, 40 wet organic, 30 dry non-metallic) was introduced into the system. The system successfully segregated 92 out of 100 objects. Errors primarily occurred with heavily crumpled dry paper falsely triggering the metallic sensor due to irregular descent profiles. Overall system accuracy was determined to be 92%, proving the viability of the concept.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={28}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 22.Stakeholders </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6"><strong>1. End Users:</strong> The general public, students, and corporate employees who deposit waste. The system offers them a seamless, guilt-free disposal experience.</p><p className="indent-12 mb-6"><strong>2. Municipal Corporations:</strong> They benefit from massive cost reductions in centralized sorting and longer lifespan of local landfills.</p><p className="indent-12 mb-6"><strong>3. Waste Management/Recycling Companies:</strong> They receive pre-sorted, high-purity raw materials, drastically increasing their operational margins.</p><p className="indent-12 mb-6"><strong>4. Institutional Management:</strong> Schools and corporates deploying these bins fulfill their sustainability goals and improve campus hygiene.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={30}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 24.Limitations </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">Despite its successes, the prototype has inherent limitations. The system processes items serially; therefore, if a user dumps a large cluster of mixed waste simultaneously, the sensors may provide conflicting readings or the mechanical flap may jam. The capacitive moisture sensor relies on direct physical contact, meaning it requires periodic manual cleaning to remain accurate.</p><p className="indent-12 mb-6">Furthermore, the current sensor array cannot distinguish between different types of dry waste, such as distinguishing glass from plastic, which would require more advanced acoustic or optical sensors.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={31}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 25.Social & Environmental impact </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6"><strong>Environmental:</strong> By accurately separating wet organic waste from dry recyclables, the system prevents the contamination of paper and plastics. This allows organic waste to be smoothly diverted to composting facilities, while maximizing the percentage of plastics that can be successfully recycled, thereby directly reducing greenhouse gas emissions from landfills.</p><p className="indent-12 mb-6"><strong>Social:</strong> Sanitation work is often dangerous and degrading due to the handling of sharp, toxic, or unsanitary mixed waste. Automating the sorting phase elevates occupational safety and dignifies waste management labor, shifting human roles from manual sorting to system maintenance and logistics management.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={32}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 26.Future Scope </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">Future iterations of this system will focus on integrating IoT capabilities. Utilizing an ESP32 microcontroller, the bins could transmit fill-levels and sorting statistics to a central cloud dashboard via Wi-Fi or LoRaWAN, enabling municipalities to optimize garbage collection routes dynamically.</p><p className="indent-12 mb-6">Additionally, machine learning models running on edge devices (like the Raspberry Pi with a camera module) could be integrated to replace or augment the physical sensors. This would allow the system to recognize specific brands, classify different grades of plastics (PET vs HDPE), and even reward users with digital tokens for proper disposal, gamifying sustainability.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={33}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 27.Conclusion </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="indent-12 mb-6">The Design and Development of the Smart Waste Segregation System validates that low-cost, decentralized automated sorting is technically and financially viable. By fusing inductive, capacitive, and infrared sensing technologies with reliable mechanical actuation, the prototype achieved a 92% segregation accuracy rate.</p><p className="indent-12 mb-6">This micro-project serves as a critical proof-of-concept demonstrating how applied electronics and engineering mechanics can effectively solve localized environmental challenges. Scaling such localized smart-bin systems possesses the disruptive potential to fundamentally transform municipal waste management, drastically reducing landfill burden and propelling society toward a sustainable, zero-waste future.</p>
            </div>
          </div>
        </Page>
        ...
        <Page pageNumber={34}>
          <div className="py-2 px-4">
            <h1 className="text-center font-bold font-serif mb-10 text-[13.5pt]">Design and Development of a Smart Waste Segregation System</h1>
            <h2 className="font-bold font-serif text-[12pt] mb-6"> 28.Reference </h2>
            <div className="font-serif text-[11.5pt] leading-[2.0] text-justify">
              <p className="ml-8 !indent-0 -ml-8">Balapriya, F., et al. (2022). "Enhanced Smart Waste Segregation and Management Using Arduino." <em>International Journal of Engineering Research & Technology (IJERT)</em>, 11(4), 112-118.</p><p className="ml-8 !indent-0 -ml-8">Khurmi, R. S., and Gupta, J. K. (2005). <em>Theory of Machines</em>. S. Chand & Company Ltd.</p><p className="ml-8 !indent-0 -ml-8">Rajkamal (2011). <em>Microcontrollers: Architecture, Programming, Interfacing and System Design</em>. Pearson Education India.</p><p className="ml-8 !indent-0 -ml-8">Central Pollution Control Board (CPCB) (2023). <em>Solid Waste Management Report</em>. Ministry of Environment, Forest and Climate Change, Government of India.</p>
            </div>
          </div>
        </Page>
        <Page pageNumber={35}>
